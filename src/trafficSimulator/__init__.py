"""
TrafficSimulator - A microscopic traffic simulation package.

This package provides classes for simulating traffic flow including vehicles,
pedestrians, road segments, and various types of pedestrian crossings.

Modules:
    core.simulation: Main simulation orchestrator
    core.vehicle: Vehicle class and behavior
    core.pedestrian: Pedestrian class and states
    core.pedestrian_crossing: Various crossing types
    visualizer.window: DearPyGui visualization
